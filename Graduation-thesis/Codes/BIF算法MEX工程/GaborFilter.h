...
// void bif2(double **ImgData,int dim1,int num1,double *ImgSize,int m_nScale,double ** outputGaborFeatureAll);
double stard_deviation(double *a,int Num);//求标准差
void C_reshape_OneToTwo(double *v,double **v1,int row,int col);//实现矩阵的转置
